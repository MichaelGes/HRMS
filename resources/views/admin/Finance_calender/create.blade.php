...
<div class="col-12" >
    <div class="card ">
      ...
      <div class="card-header">
        <h4 style="width: 100%;text-align:center">انشاء سنة مالية جديدة</h4>  
      </div>
      <div class="card-body">
     ...
     <div class="col-md-4">
        <div class="form-group">
           ...
           <input type="text" name="FINANCE_YR_DESC" id="FINANCE_YR_DESC" class="form-control" value="{{old('FINANCE_YR_DESC')  }}" placeholder="">
     ...
     <div class="col-md-4">
      <div class="form-group">
         ...
         <input type="date" name="start_date" id="start_date" class="form-control" value="{{old('start_date')  }}" placeholder="">
         @error('start_date')
         <span class="text-danger">{{ $message }}</span> 
         @enderror
      </div>
   ...
   <div class="col-md-4">
    <div class="form-group">
       ...
       <input type="date" name="end_date" id="end_date" class="form-control" value="{{old('end_date')  }}" placeholder="">
       @error('end_date')
       <span class="text-danger">{{ $message }}</span> 
       @enderror
    </div>
