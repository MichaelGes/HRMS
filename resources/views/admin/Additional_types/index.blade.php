...
<section class="section " style="direction: rtl;">
  <div class="section-body">
    <div class="row">
      <div class="col-12">
        <div class="card ">
          <a href="{{ route('AdditionalTypes.create') }}" class="btn btn-primary">اضافة جديد</a>
          <div class="card-header">
            <h4>بيانات انواع الاضافي علي الراتب</h4>
          </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <div class="dropdown-menu text-center">
                      <a class="dropdown-item has-icon" href="{{ route('AdditionalTypes.edit',$info->id) }}"><i class="far fa-edit"></i> تعديل</a>
                      <a class="dropdown-item has-icon are_you_shur del" href="{{ route('AdditionalTypes.destroy',$info->id) }}"><i class="
