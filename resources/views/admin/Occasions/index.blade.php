...
<section class="section " style="direction: rtl;">
  <div class="section-body">
    <div class="row">
      <div class="col-12">
        <div class="card ">
          <a href="{{ route('occasions.create') }}" class="btn btn-primary">اضافة جديد</a>
          <div class="card-header">
            <h4>المناسبات الرسمة</h4>
          </div>
                  ...
                  <tr>
                   ...
                   <td>{{ $info->days_counter }}</td> 
                    ...
                    <div class="dropdown-menu text-center">
                      <a class="dropdown-item has-icon" href="{{ route('occasions.edit',$info->id) }}"><i class="far fa-edit"></i> تعديل</a>
                      <a class="dropdown-item has-icon are_you_shur del" href="{{ route('occasions.destroy',$info->id) }}"><i class="
