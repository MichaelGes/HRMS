    ...
    .card .card-header h4{
       ...
       <div class="col-12">
            <div class="card">
               ...
               <div class="card-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                     ...
                     <tr>
                        ...
                        <td> 
                           <img src="{{ asset('assets/admin/upload').'/'.$data['image'] }}" style="border-radius: 50% ; width: 80px ; height: 80px ; padding: 10px;" class="rounded_circle" alt="شعار الشركة"/>
                        </td>
                     </tr>
               ...
               <a href="{{ route ('admin_panel_settings.edit') }}" class="btn btn-icon icon-left btn-info"><i class="fas fa-info-circle"></i> تعديل بيانات النظام</a>
            </div>
         </div>
@endsection