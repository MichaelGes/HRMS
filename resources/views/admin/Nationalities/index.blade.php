                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <div class="dropdown-menu text-center">
                      <a class="dropdown-item has-icon" href="{{ route('Nationalities.edit',$info->id) }}"><i class="far fa-edit"></i> تعديل</a>
                      <a class="dropdown-item has-icon are_you_shur del" href="{{ route('Nationalities.destroy',$info->id) }}"><i class="
