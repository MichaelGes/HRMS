...
<div class="card-header">
      <h4 style="width: 100%;text-align:center">اضافة موظف جديد</h4>
</div>
<div class="card-body">
...
<div class="card-body">
   ...
   <div class="tab-pane fade show active" id="home2" role="tabpanel"
      ...
      <div class="row">
         <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input autofocus type="text" name="zketo_code" id="zketo_code" oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                     class="form-control" value="{{ old('zketo_code') }}">
                  @error('zketo_code')
         ...
         <div class="col-md-4">
               <div class="form-group">
                  ...
                  <select name="emp_gender" id="emp_gender" class="form-control">
                     ...
                     <option @if (old('emp_gender') == 1) selected @endif
                           value="1">ذكر</option>
                     <option @if (old('emp_gender') == 2) selected @endif
                           value="2">انثي</option>
                  </select>
                  @error('emp_gender')
                     <span class="text-danger">{{ $message }}</span>
                  ...
                  <select name="Qualifications_id" id="Qualifications_id  "
                     ...
                     @if (@isset($other['qualifications']) && !@empty($other['qualifications']))
                           @foreach ($other['qualifications'] as $info)
                              <option
                                 @if (old('Qualifications_id') == $info->id) selected="selected" @endif
                                 value="{{ $info->id }}"> {{ $info->name }}
                              </option>
                           @endforeach
                     @endif
         ...
         <div class="col-md-4">
               <div class="form-group">
                  ...
                  <select name="graduation_estimate" id="graduation_estimate"
                     class="form-control">
                     <option @if (old('graduation_estimate') == 1) selected @endif
                           value="1">مقبول</option>
                     <option @if (old('graduation_estimate') == 2) selected @endif
                           value="2">جيد</option>
                     <option @if (old('graduation_estimate') == 3) selected @endif
                           value="3">جيد مرتفع</option>
                     <option @if (old('graduation_estimate') == 4) selected @endif
                           value="4">جيد جداً</option>
                     <option @if (old('graduation_estimate') == 5) selected @endif
         ...
         <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input type="date" name="brith_date" id="brith_date"
                     class="form-control" value="{{ old('brith_date') }}">
                  @error('brith_date')
                     <span class="text-danger">{{ $message }}</span>
                  @enderror
               </div>
         ...
         <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input type="text" name="emp_national_idenity"
                     ...
                     value="{{ old('emp_national_idenity') }}">
         ...
         <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input type="date" name="emp_end_identityIDate"
                     ...
                     value="{{ old('emp_end_identityIDate') }}">
                  ...
                  <select name="blood_group_id" id="blood_group_id"
                     ...
                     @if (@isset($other['blood_groups']) && !@empty($other['blood_groups']))
                           @foreach ($other['blood_groups'] as $info)
                              <option
                                 @if (old('blood_group_id') == $info->id) selected="selected" @endif
                                 value="{{ $info->id }}"> {{ $info->name }}
                              </option>
                           @endforeach
                     @endif
                  ...
                  <select name="emp_nationality_id" id="emp_nationality_id"
                     ...
                     @if (@isset($other['nationalities']) && !@empty($other['nationalities']))
                           @foreach ($other['nationalities'] as $info)
                              <option
                                 @if (old('emp_nationality_id') == $info->id) selected="selected" @endif
                                 value="{{ $info->id }}"> {{ $info->name }}
                              </option>
                           @endforeach
                     @endif
                  ...
                  <select name="religion_id" id="religion_id"
                     ...
                     @if (@isset($other['religions']) && !@empty($other['religions']))
                           @foreach ($other['religions'] as $info)
                              <option
                                 @if (old('religion_id') == $info->id) selected="selected" @endif
                                 value="{{ $info->id }}"> {{ $info->name }}
                              </option>
                           @endforeach
                     @endif
         ...
         <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input type="text" name="emp_email" id="emp_email"
                     class="form-control" value="{{ old('emp_email') }}">
                  @error('emp_email')
                     <span class="text-danger">{{ $message }}</span>
                  @enderror
               </div>
         ...
         <div class="col-md-8">
               <div class="form-group">
                  ...
                  <input type="text" name="staies_address" id="staies_address"
                     class="form-control" value="{{ old('staies_address') }}">
         ...
         <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input type="text" name="emp_home_tel" id="emp_home_tel"
                     class="form-control" value="{{ old('emp_home_tel') }}">
                  @error('emp_home_tel')
                     <span class="text-danger">{{ $message }}</span>
                  @enderror
               </div>
         ...
         <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input type="text" name="emp_work_tel" id="emp_work_tel"
                     class="form-control" value="{{ old('emp_work_tel') }}">
                  @error('emp_work_tel')
                     <span class="text-danger">{{ $message }}</span>
                  @enderror
               </div>
                  ...
                  <select name="emp_military_id" id="emp_military_id"
                     ...
                     @if (@isset($other['military_status']) && !@empty($other['military_status']))
                           @foreach ($other['military_status'] as $info)
                              <option @if(old('emp_military_id') == $info->id) selected="selected" @endif
                                 value="{{ $info->id }}"> {{ $info->name }}
                              </option>
                           @endforeach
                     @endif
         ...
         <div class="col-md-4 related_miltary_1" @if(old('emp_military_id')!=1) style="display: none;" @endif>
               <div class="form-group">
                  ...
                  <input type="date" name="emp_military_date_from"
                     ...
                     value="{{ old('emp_military_date_from') }}">
         ...
         <div class="col-md-4 related_miltary_1" @if(old('emp_military_id')!=1) style="display: none;" @endif>
               <div class="form-group">
                  ...
                  <input type="date" name="emp_military_date_to"
                     ...
                     value="{{ old('emp_military_date_to') }}">
         ...
         <div class="col-md-4 related_miltary_2" @if(old('emp_military_id')!=2) style="display: none;" @endif>
               <div class="form-group">
                  ...
                  <input type="date" name="exemption_date" id="exemption_date"
                     class="form-control" value="{{ old('exemption_date') }}">
         ...
         <div class="col-md-4" >
               <div class="form-group">
                  ...
                  <select name="does_has_Driving_License"
                     ...
                     <option @if (old('graduation_estimate') == 1) selected @endif
                           value="1">نعم </option>
                     <option @if (old('graduation_estimate') == 0 and old('graduation_estimate') != '') selected @endif
                           value="2">لا</option>
                  </select>
         ...
         <div class="col-md-12 Related_Relatives_detailsDiv"  @if(old('has_Relatives')!=1) style="display: none;" @endif>
            <div class="form-group">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input type="date" name="emp_start_date" id="emp_start_date"
                     class="form-control" value="{{ old('emp_start_date') }}">
         ...
         <div class="col-md-4">
            <div class="form-group">
               ...
               <select name="Functiona_status" id="Functiona_status"
                  class="form-control">
                  <option value="">اختر الحالة</option>
                  <option @if (old('Functiona_status') == 1) selected @endif
                        value="1">يعمل </option>
                  <option @if (old('Functiona_status') == 0 and old('Functiona_status')!="") selected @endif
            ...
            <select name="emp_Departments_code" id="emp_Departments_code"
               ...
               @if (@isset($other['departements']) && !@empty($other['departements']))
                     @foreach ($other['departements'] as $info)
                        <option
                           @if (old('departements_id') == $info->id) selected="selected" @endif
                           value="{{ $info->id }}"> {{ $info->name }}
                        </option>
                     @endforeach
               @endif
            ...
            <select name="emp_jobs_id" id="emp_jobs_id"
               ...
               @if (@isset($other['jobs']) && !@empty($other['jobs']))
                     @foreach ($other['jobs'] as $info)
                        <option
                           @if (old('emp_jobs_id') == $info->id) selected="selected" @endif
                           value="{{ $info->id }}"> {{ $info->name }}
                        </option>
                     @endforeach
               @endif
   ...
   <div class="col-md-4">
      <div class="form-group">
         ...
         <select name="does_has_ateendance" id="does_has_ateendance"
            class="form-control">
            <option value=""></option>
            <option @if (old('does_has_ateendance') == 1)  @endif
                  value="1">نعم</option>
            <option @if (old('does_has_ateendance') == 0 and old('does_has_ateendance')!="") @endif
                  value="0">لا</option> 
         </select>
...
<div class="col-md-4">
   <div class="form-group">
      ...
      <select name="is_has_fixced_shift" id="is_has_fixced_shift"
         class="form-control">
         <option value="">اختر الحالة</option>
         <option @if (old('is_has_fixced_shift') == 1)  @endif
               value="1">نعم يعمل بشفت ثابت</option>
         <option @if (old('is_has_fixced_shift') == 0 and old('is_has_fixced_shift')!="")  @endif
...
<div class="col-md-4 relatedfixced_shift" @if(old('is_has_fixced_shift')==0 || old('is_has_fixced_shift')=="") style="display: none;" @endif>
   <div class="form-group">
      ...
      <select name="shifts_types_id" id="shifts_types_id" class="form-control select2 ">
         ...
         <option @if(old('shifts_types_id')==$info->id)  @endif value="{{ $info->id }}">
...
<div class="col-md-4" id="daily_work_hourDiv" @if(old('is_has_fixced_shift')==1 || old('is_has_fixced_shift')=="") style="display: none;" @endif>
   <div class="form-group">
      ...
      <input type="text" name="daily_work_hour" id="daily_work_hour" oninput="this.value=this.value.replace(/[^0-9.]/g,'');" class="form-control" value="{{ old('daily_work_hour') }}" placeholder="عدد ساعات العمل اذا كان ليس لة شيفت ثابت" >
...
<div class="col-md-4 relatedisSocialnsurance" @if(old('isSocialnsurance')!=1) style="display: none;" @endif>
   <div class="form-group">
      ...
      <input type="text" name="isSocialnsurance" id="SocialnsuranceNumber" class="form-control" value="{{ old('SocialnsuranceNumber') }}" >
